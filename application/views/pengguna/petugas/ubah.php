<div class="card pt-4 pl-5 pr-5">
	<form action="" method="post">
		<div class="form-group row">
			...
			<div class="col-sm-8">
				<input type="text" name="nama_petugas" id="namaPetugas" class="form-control" placeholder="" aria-describedby="helpId" value="<?= $petugas->nama_petugas ?>">
		...
		<div class="form-group row">
			...
			<div class="col-sm-8">
				<input type="text" name="username" id="username" class="form-control" placeholder="" aria-describedby="helpId" value="<?= $petugas->username ?>">
		...
		<div class="form-group row">
			...
			<div class="col-sm-8">
				<input type="number" name="telp" id="telp" class="form-control" placeholder="" aria-describedby="helpId" value="<?= $petugas->telp ?>">
		...
		<div class="form-group row">
			...
			<div class="col-sm-8">
				<input type="password" name="password" id="password" class="form-control" placeholder="" aria-describedby="helpId" value="<?= $petugas->password ?>">
		...
		<br>
		<div class="form-group rowp-2 float-right" style="margin-right: 8%;">

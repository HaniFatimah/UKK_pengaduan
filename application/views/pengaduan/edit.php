...
<div class="card pt-4 pl-5 pr-5">
	<form action="" method="post" enctype="multipart/form-data">
		<div class="form-group row">
			...
			<div class="col-sm-8">
				<textarea name="isi" class="form-control" id="isilaporan" rows="4" required value="<?= $pengaduan->isi_laporan?>"></textarea>
		...
		<div class="form-group row">
			...
			<div class="col-sm-8">
				<input type="file" name="foto" id="foto" class="form-control" placeholder="" aria-describedby="helpId" value="<?= $pengaduan->foto ?>" required>

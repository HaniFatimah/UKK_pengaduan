...
<div class="card pt-4 pl-5 pr-5">
	<form action="" method="post" enctype="multipart/form-data">
		<div class="form-group row">
			...
			<div class="col-sm-8">
				<textarea name="isi" class="form-control" id="isilaporan" rows="4" required><?php echo htmlspecialchars($pengaduan->isi_laporan); ?></textarea>
		...
		<div class="form-group row">
			...
			<div class="col-sm-8">
				<input type="file" name="foto" id="foto" class="form-control" placeholder="" aria-describedby="helpId" required <?php echo htmlspecialchars($pengaduan->foto); ?>>
				<small id="helpId" class="text-muted"><?php echo form_error('foto', '<div class="alert alert-danger mt-2">', '</div>'); ?></small>
			</div>
		</div>
		<br>
		<div class="form-group row p-2 float-right" style="margin-right: 8%;">
